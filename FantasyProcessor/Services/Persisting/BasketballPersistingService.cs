...
public class BasketballPersistingService : ConnectedService<List<APIs.CBS.Player>>
{
    public BasketballPersistingService(BasketballChannelService channelService, ILogger<BasketballPersistingService> logger)
